# Generated by Django 3.2 on 2023-05-10 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(help_text='Цветовой HEX-код', max_length=7, unique=True, validators=[recipes.validators.hex_field_validator], verbose_name='Цветовой HEX-код')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(limit_value=1, message='Количество должно быть больше 0.'), django.core.validators.MaxValueValidator(limit_value=1000, message='Количество ингредиентов не может быть больше 1000!')], verbose_name='Количество ингредиента в рецепте')),
